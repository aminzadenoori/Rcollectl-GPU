...
![CPU/GPU Monitoring Plot]([https://via.placeholder.com/400x300?text=CPU+GPU+Usage+Plot](https://github.com/aminzadenoori/Rcollectl-GPU/blob/develgpu/image%20(1).png))
